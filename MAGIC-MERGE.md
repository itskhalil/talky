...
- **Vocabulary**: If you wrote "Kubernetes", use that spelling even if the transcript heard "shiba"
...
- Q3 timeline - end of Q3 target, depends on Kubernetes deployment
- Kubernetes blocker - security review pending, Alice escalating today
...
- Project codenames (Kubernetes → "shiba")
...
3. Use vocabulary from user's notes throughout (e.g., "Kubernetes" not "shiba")
...
- Kubernetes blocker - security review pending, Alice escalating today
- Q3 timeline - targeting end of Q3, contingent on Kubernetes deployment
...
## Technical
- Kubernetes blocker - main dependency for Q3 timeline
